...
export default function Introduction() {
  return (
    <section className="py-12 md:py-24 bg-white dark:bg-[#1E1E1E] px-4 sm:px-6 lg:px-8">
      ...
      >
        <h2 className="font-serif text-3xl md:text-5xl text-forest dark:text-stone-200 mb-8 font-semibold tracking-wide">
          Welcome to Resort Arranyak
        </h2>
        
        <div className="w-24 h-1 bg-gold mx-auto mb-10 rounded-full opacity-80" />
        
        <div className="space-y-8 text-stone-700 dark:text-stone-300 text-lg md:text-xl font-light leading-relaxed tracking-wide">
          <p>
          ...
          <p className="font-medium text-forest dark:text-stone-200">
