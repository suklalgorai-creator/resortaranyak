...
const stats = [
  { label: 'Total Bookings', value: '156', change: '+12%', icon: '??', color: 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400' },
  { label: 'Revenue (This Month)', value: '?2,45,000', change: '+8%', icon: '??', color: 'bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400' },
  { label: 'Pending Enquiries', value: '23', change: '+5', icon: '??', color: 'bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-400' },
  { label: 'Occupancy Rate', value: '78%', change: '+3%', icon: '??', color: 'bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400' },
];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <a href="/admin/rooms/new" className="flex items-center gap-3 bg-green-600 hover:bg-green-700 text-white p-4 rounded-xl transition-colors font-medium">
          <span className="text-2xl">?</span> Add New Room
        </a>
        <a href="/admin/enquiries" className="flex items-center gap-3 bg-amber-500 hover:bg-amber-600 text-white p-4 rounded-xl transition-colors font-medium">
          <span className="text-2xl">??</span> View Enquiries
        </a>
        <a href="/admin/gallery" className="flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-xl transition-colors font-medium">
          <span className="text-2xl">??</span> Upload Photos
        </a>
      </div>
      ...
      <div className="bg-white glass-card rounded-xl border border-stone-200 dark:border-stone-800">
        <div className="p-6 border-b border-stone-200 dark:border-stone-800 flex items-center justify-between">
          ...
          <a href="/admin/bookings" className="text-sm text-green-600 dark:text-green-400 hover:underline">View All ?</a>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              {recentBookings.map((booking) => (
                <tr key={booking.id} className="border-b border-stone-50 dark:border-stone-800/50 hover:bg-stone-50 dark:hover:bg-stone-800/30 transition-colors">
