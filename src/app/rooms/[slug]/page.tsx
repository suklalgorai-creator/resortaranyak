      ...
      <div className="container mx-auto max-w-6xl px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            <section>
              <h2 className="text-3xl font-serif font-semibold text-stone-800 mb-6">About this room</h2>
            ...
            <section>
              <h3 className="text-2xl font-serif font-semibold text-stone-800 mb-6">Room Amenities</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {roomAmenities.map((amenity, index) => (
                  <div key={index} className="flex items-center gap-3 text-stone-700 bg-white p-4 rounded-xl border border-stone-100 shadow-sm">
            ...
            <section>
              <h3 className="text-2xl font-serif font-semibold text-stone-800 mb-6">Resort Facilities</h3>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-white rounded-2xl shadow-xl border border-stone-100 p-8">
              <div className="mb-6 pb-6 border-b border-stone-100">
                <div className="text-3xl font-bold text-emerald-800 mb-1">
                  ₹{room.price}
                </div>
                <div className="text-stone-500 text-sm">per night, excluding taxes</div>
              </div>

              <div className="space-y-4 mb-8">
                <div className="flex justify-between items-center text-stone-600">
                  <span>Max Capacity</span>
                  <span className="font-semibold text-stone-800">{room.capacity}</span>
                </div>
                <div className="flex justify-between items-center text-stone-600">
                  <span>Bed Type</span>
                  <span className="font-semibold text-stone-800">King/Twin</span>
                </div>
              </div>

              <button className="w-full bg-emerald-700 hover:bg-emerald-800 text-white py-4 rounded-xl font-semibold text-lg transition-colors duration-200 shadow-lg shadow-emerald-200">
                Check Availability
              </button>
